...
const Footer = () => {
    ...
    return (
        <div className="crad shadow-xl bg-black">
            <div className="p-14">
                ...
                <div className="mt-10 flex justify-center">
                    <div className='flex gap-10 text-[4vw] lg:text-[1vw]'>
                        <NavLink className={`${path === '/' && 'border-b border-b-themeColor text-themeColor'} text-white`} to='/'>Home</NavLink>
                        <NavLink className={`${path === '/about' && 'border-b border-b-themeColor text-themeColor'} text-white`} to='/about'>About</NavLink>
                        <NavLink className={`${path === '/work' && 'border-b border-b-themeColor text-themeColor'} text-white`} to='/work'>Work</NavLink>
                        <NavLink className={`${path === '/contact' && 'border-b border-b-themeColor text-themeColor'} text-white`} to='/contact'>Contact</NavLink>
                    </div>
                </div>
            </div>
