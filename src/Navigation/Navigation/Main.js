                  ...
                  <div className='flex gap-10 text-lg'>
                    {
                      ...
                      <>
                        <NavLink className={`${path === '/' && 'border-b border-b-themeColor text-themeColor dark:text-themeColor'} dark:text-white`} to='/'>Home</NavLink>
                        <NavLink className={`${path === '/about' && 'border-b border-b-themeColor text-themeColor dark:text-themeColor'} dark:text-white`} to='/about'>About</NavLink>
                        <a className={`${path === '/work' && 'border-b border-b-themeColor text-themeColor dark:text-themeColor'} dark:text-white`}
                          href="#"
                          onClick={(e) => {
                        ...
                        <NavLink className={`${path === '/contact' && 'border-b border-b-themeColor text-themeColor dark:text-themeColor'} dark:text-white`} to='/contact'>Contact</NavLink>
                      </>
                    }
